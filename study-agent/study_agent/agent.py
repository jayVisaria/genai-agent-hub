...
# TODO: Import the sub-agents once they are created
...
study_coordinator = Agent(
    ...
    model=MODEL,
    description="A specialized study coordinator that orchestrates a personalized and interactive learning experience through specialized agents.",
    instruction=prompt.STUDY_COORDINATOR_PROMPT,
    # TODO: Add the agent tools once the sub-agents are created
    tools=[],
